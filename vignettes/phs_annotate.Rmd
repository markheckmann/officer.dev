...
```{r echo=FALSE, out.width="80%"}
knitr::include_graphics("img_phs_annotate_subset.png")
```
...
```{r echo=FALSE, out.width="80%"}
knitr::include_graphics("img_phs_annotate_all_slides.png")
```
...
```{r echo=FALSE, out.width="80%"}
knitr::include_graphics("img_phs_annotate_custom.png")
```
...
```{r echo=FALSE, out.width="80%"}
knitr::include_graphics("img_phs_annotate_labels_only.png")
```
