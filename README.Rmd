...
The project stays as closely aligned with upstream `officer` as possible.
...
This package tracks [`davidgohel/officer`](https://github.com/davidgohel/officer).
All credit for the original work belongs to the officer authors.
